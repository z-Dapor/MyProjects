...
public class Pinyin4jUtil {
	...
	public static Set<String> getPinyin(String src) {
		if (src != null && !src.trim().equalsIgnoreCase("")) {
			try {
				...
				chooseLettersAndChinese(srcChar,temp,hanYuPinOutputFormat);
	...
	private static void chooseLettersAndChinese(char[] srcChar,String[][] temp,HanyuPinyinOutputFormat hanYuPinOutputFormat){
